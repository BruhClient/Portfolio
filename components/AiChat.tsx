  ...
  if (open) {
    return (
      <MotionDiv
        ...
        initial={"initial"}
        animate={"visible"}
        className="fixed flex flex-col gap-3 right-4 bottom-3 w-[300px] lg:w-[400px] h-[500px] bg-card shadow-lg border-2 rounded-lg px-4 py-4 z-50"
      >
        <Button
          variant={"ghost"}
          size={"icon"}
        ...
        <div className="flex gap-3 items-center">
          ...
          <div>
            <div className="font-semibold">Travis Ang</div>
          ...
          {[
            {
              role: "assistant",
              content:
                "Hey , Im Travis . Thank you for viewing my website . How can i help you ? ",
              id: "header",
            },
            ...messages,
          ].map((message) => {
